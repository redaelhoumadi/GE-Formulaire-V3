...
export default function CallbackInput(props: CallbackInputProps) {
    ...
    return (
        <div className="hidden lg:flex">
            {/* CTA button or form */}
            {(!open || loading || sent) ? (
                <ButtonPill onClick={onClick} padding="py-2.5 px-10" style={sent ? undefined : "success"} className={`cursor-pointer ${sent ? 'bg-ge-green/10 text-ge-green border border-ge-green/30' : ''}`}>
