...
import { CheckCircle, Calendar, Clock, Car, Shield, MapPin, User, Settings } from "lucide-react";
...
const iconMap: Record<string, React.ReactNode> = {
    intervention: <Clock className="w-3.5 h-3.5 text-ge-gray-1 group-hover:text-ge-green" />,
    dommage: <Settings className="w-3.5 h-3.5 text-ge-gray-1  group-hover:text-ge-green" />,
    vehicule: <Car className="w-3.5 h-3.5 text-ge-gray-1  group-hover:text-ge-green" />,
    assurance: <Shield className="w-3.5 h-3.5 text-ge-gray-1  group-hover:text-ge-green" />,
    rdv: <MapPin className="w-3.5 h-3.5 text-ge-gray-1  group-hover:text-ge-green" />,
    coord: <User className="w-3.5 h-3.5 text-ge-gray-1  group-hover:text-ge-green" />,
};
...
function RecapRow({ item }: { item: RecapItem }) {
    return (
        <div className="flex items-start gap-3 py-2.5 border-b border-ge-gray-5 last:border-0 group">
            <div className="mt-0.5 w-6 h-6 rounded-full bg-ge-gray-4 flex items-center justify-center shrink-0 group-hover:bg-ge-green/20 transition-colors">
                {item.icon}
            </div>
